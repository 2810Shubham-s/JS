...
\newpage
% ═══════════════════════════════════════════════════════════
%  6. TOOLS AND TECHNOLOGIES used in the project
% ═══════════════════════════════════════════════════════════
...
\newpage
% ═══════════════════════════════════════════════════════════
%  7. SYSTEM REQUIREMENTS and needs
% ═══════════════════════════════════════════════════════════
...
% ═══════════════════════════════════════════════════════════
%  8. EXPECTED OUTCOMES of the project how it will work
% ═══════════════════════════════════════════════════════════
...
% ═══════════════════════════════════════════════════════════
%  9. PROJECT TIMELINEs (thime take to complete diffrent phases)
% ═══════════════════════════════════════════════════════════
...
% ═══════════════════════════════════════════════════════════
%  10. REFERENCES of websites and information
% ═══════════════════════════════════════════════════════════
\section{References}
